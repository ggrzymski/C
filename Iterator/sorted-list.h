...
/* I am creating a linked list data structure with struct Node as my primary
  * data type. It will contain void * data and a pointer to the next Node
  * in the linked list. It will also have a reference count field, which refers
  * to the amount of objects pointing to that node. */
 ...
 * It will contain a head pointer of the linked list, and the comparator function pointer, */
 ...
 * 
 * I am in need of one node that will traverse the list.
 */
